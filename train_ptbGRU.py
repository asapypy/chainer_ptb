...
# Prepare RNNLM model, defined in netGRU.py
lm = netGRU.RNNLMGRU(len(vocab), n_units)
...
serializers.save_npz('rnnlmGRU.model', model)
print('save the optimizer')
serializers.save_npz('rnnlmGRU.state', optimizer)
